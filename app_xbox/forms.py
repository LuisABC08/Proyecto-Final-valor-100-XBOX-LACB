...
from .models import Cliente, Videojuego, Consola, Accesorio  
...
class ConsolaForm(forms.ModelForm):
    class Meta:
        ...
        widgets = {
            ...
            'almacenar_tipo': forms.TextInput(attrs={'class': 'form-control'}),
            'almacenar_espacio': forms.TextInput(attrs={'class': 'form-control'}),
            'precio': forms.NumberInput(attrs={'class': 'form-control'}),
            'stock': forms.NumberInput(attrs={'class': 'form-control'}),
            'imagen': forms.FileInput(attrs={'class': 'form-control'}),
        }
...
class AccesorioForm(forms.ModelForm):
    class Meta:
        ...
        widgets = {
            'nombre': forms.TextInput(attrs={'class': 'form-control'}),
            'categoria': forms.TextInput(attrs={'class': 'form-control', 'placeholder': 'Ej: Audífonos, Control, Cable...'}),
            'precio': forms.NumberInput(attrs={'class': 'form-control'}),
