...
urlpatterns = [
    ...
    path('videojuegos/detalle/<int:id>/', views.detalle_videojuego, name='detalle_videojuego'),
    

    # Rutas ACCESORIOS
    path('accesorios/', views.lista_accesorios, name='lista_accesorios'),
    path('accesorios/detalle/<int:id>/', views.detalle_accesorio, name='detalle_accesorio'),
    path('accesorios/crear/', views.crear_accesorio, name='crear_accesorio'),
...
# Rutas CONSOLAS
    path('consolas/detalle/<int:id>/', views.detalle_consola, name='detalle_consola'),
    path('consolas/crear/', views.crear_consola, name='crear_consola'),
    path('consolas/editar/<int:id>/', views.editar_consola, name='editar_consola'),
    path('consolas/eliminar/<int:id>/', views.eliminar_consola, name='eliminar_consola'),
    ...
    # ZONA ADMIN
    path('admin-panel/pedidos/', views.admin_lista_pedidos, name='admin_lista_pedidos'),
    path('admin-panel/clientes/', views.admin_lista_clientes, name='admin_lista_clientes'),
